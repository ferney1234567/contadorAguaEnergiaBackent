...
from app.routers import agua, energia, inspeccion_sanitario, lecturas, metas, comparativoAgua, comparativoEnergia, inspeccion_residuos,areas, inspeccion_energia, areas_sanitaria, areas_resmas,resmas, sedes
